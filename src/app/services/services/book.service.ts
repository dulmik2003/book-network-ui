...
import { approveReturnOfBorrowedBook } from '../fn/book/approve-return-of-borrowed-book';
import { ApproveReturnOfBorrowedBook$Params } from '../fn/book/approve-return-of-borrowed-book';
...
import { findBookId } from '../fn/book/find-book-id';
import { FindBookId$Params } from '../fn/book/find-book-id';
...
export class BookService extends BaseService {
  ...
  static readonly ReturnBorrowedBookPath = '/books/borrowed/return/{book-id}';
  ...
  /** Path part for operation `approveReturnOfBorrowedBook()` */
  static readonly ApproveReturnOfBorrowedBookPath = '/books/borrowed/return/approve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approveReturnOfBorrowedBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnOfBorrowedBook$Response(params: ApproveReturnOfBorrowedBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approveReturnOfBorrowedBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approveReturnOfBorrowedBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approveReturnOfBorrowedBook(params: ApproveReturnOfBorrowedBook$Params, context?: HttpContext): Observable<number> {
    return this.approveReturnOfBorrowedBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
  ...
  /** Path part for operation `findBookId()` */
  static readonly FindBookIdPath = '/books/get/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `findBookId()` instead.
   *
   * This method doesn't expect any request body.
   */
  findBookId$Response(params: FindBookId$Params, context?: HttpContext): Observable<StrictHttpResponse<BookResponse>> {
    return findBookId(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `findBookId$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  findBookId(params: FindBookId$Params, context?: HttpContext): Observable<BookResponse> {
    return this.findBookId$Response(params, context).pipe(
  ...
  static readonly FindAllBooksPath = '/books/all-books';
